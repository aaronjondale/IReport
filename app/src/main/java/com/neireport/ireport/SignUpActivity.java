...
public class SignUpActivity extends AppCompatActivity {
    ...
    private EditText field_confirmPassword, field_emailAddress, field_name, field_password;
    ...
    public void createAccountButton(View view) {
        ...
        if (validateUserInputs(confirmPassword, emailAddress, name, password)) {
            createFirebaseAccount(emailAddress, name, password);
        }
    }

    private void createFirebaseAccount(final String emailAddress, final String name, String password) {
        showProgressBar();
        authentication.createUserWithEmailAndPassword(emailAddress, password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                if (task.isSuccessful()) {
                    uploadUserInformationToFirestore(emailAddress, name);
                } else {
                    hideProgressBar();
    ...
    private void uploadUserInformationToFirestore(String emailAddress, String name) {
    ...
    private boolean validateUserInputs(String confirmPassword, String emailAddress, String name, String password) {
        int error = 0;

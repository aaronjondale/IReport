...
public class UserProfileImageActivity extends AppCompatActivity {
    ...
    private void uploadToStorage() {
        ...
        final StorageReference filePath = storage.getReference().child("Users").child("Profile").child(userID + ".jpg");
    ...
    private void uploadToFirestore(Uri uri_image, String userID) {
        ...
        firestore.collection("Users").document(userID).update("Profile Image Link", url_file).addOnCompleteListener(new OnCompleteListener<Void>() {
            @Override
